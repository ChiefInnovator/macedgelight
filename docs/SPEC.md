...
Currently uses automatic local development signing. Not signed with Apple Developer ID — requires Gatekeeper bypass (`xattr -cr`) or right-click → Open for first launch.
